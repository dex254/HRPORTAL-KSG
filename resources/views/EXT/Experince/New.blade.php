        ...
        <div class="page-content">
            ...
            <div class="ms-auto">
                <div class="d-flex justify-content-start mt-4">
                    <a href="{{ route('EXT.Proffecional.Body') }}" class="btn previous-button px-4 py-2 me-3">Previous</a>

                    <button onclick="location.href='{{ route('EXT.Special.Licence') }}'" class="btn next-button px-4 py-2">
                        Next
                    </button>
...
<script>
    ...
    if (document.getElementById('error-message')) {
        flickerEffect('error-message');
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Delete Button -->
                            <form action="{{ route('EXT.Experience.destroyext', $experience->id) }}" method="POST">
    @csrf
    @method('DELETE')
    <button type="submit" class="btn btn-danger btn-sm">Delete</button>
                ...
                <div id="academicModal" class="modal">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('EXT.Experince.Ext') }}"   method="POST"  >
                            @csrf
    ...
    <select id="employer_type" class="form-control">
...
<div class="form-group mb-3">
    ...
    <input type="text" id="organization_name" class="form-control" placeholder="e.g. Ministry of Education">
</div>

<!-- This is the field that will be saved -->
<div class="form-group mb-3">
    <label for="employer">Employer</label>
    <input type="text" id="employer" name="employer" class="form-control" readonly required>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateEmployerField() {
            ...
            if (type && org) {
                employerField.value = `(${type}) - ${org}`;
            } else {
                employerField.value = '';
            }
        }

        typeSelect.addEventListener('change', updateEmployerField);
        orgInput.addEventListener('input', updateEmployerField);
    });
</script>
