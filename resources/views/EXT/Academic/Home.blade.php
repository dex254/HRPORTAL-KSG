        ...
        <div class="page-content">
            ...
            <div class="ms-auto">
                <div class="d-flex justify-content-start mt-4">
                    <a href="{{ route('EXT.Dashboard') }}" class="btn previous-button px-4 py-2 me-3">Previous</a>
                
                    <button onclick="location.href='{{ route('EXT.Proffecional.Body') }}'" class="btn next-button px-4 py-2">
                        Next
                    </button>
                </div>
        ...
        flickerEffect('error-message');
               ...
               <div id="academicModal" class="modal">
                <div class="modal-content">
                    ...
                    <form action="{{ route('EXT.Academic.Ext') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Hidden Fields -->
    ...
    transition: width 0.3s ease;
            ...
            <div id="trainingModal" class="modal">
                <div class="modal-content">
                    ...
                    <form action="{{ route('EXT.Academic.Trainingext') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Hidden Fields -->
                        <input type="hidden" name="upn_no" value="{{ Auth::guard('EXT')->user()->upn_no }}">
                        <input type="hidden" name="email" value="{{ Auth::guard('EXT')->user()->email }}">
