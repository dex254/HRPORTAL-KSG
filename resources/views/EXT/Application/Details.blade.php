    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="/My_applications_online">My Applications</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <p><strong>Job:</strong> {{ $extjobs->Designation }}</p>
                            <p><strong>Reference No:</strong> {{ $extjobs->Ref_No }}</p>
                            <p><strong>Level:</strong> {{ $extjobs->level ?? 'N/A' }}</p>
                            
                            <p><strong>Positions:</strong> {{ $extjobs->Proposed_No_of_Positions }}</p>
                            <p><strong>Application Deadline:</strong> {{ $extjobs->deadline }}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-4 d-flex justify-content-between">
                <a href="/My_applications_online" class="btn btn-secondary">
                    <i class="fa fa-arrow-left"></i> Back to Applications
                </a>
                <form action="{{ route('MY.Delete', ['id' => $application->id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this application?');">
                    @csrf
                    @method('DELETE')
