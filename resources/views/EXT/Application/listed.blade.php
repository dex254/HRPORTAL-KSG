    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"> External  Jobs Listings</div>
                <div class="ps-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto">
                            <a href="/Create_a_new_jod_ext_advart" class="btn btn-light radius-30 mt-2 mt-lg-0">
...
<td>{{ $record->Designation }}</td>
                                    ...
                                    <td>{{ $record->status }}</td>
                                    <td>
                                        <a  href="{{ route('EXT.Application.detail', ['id' => $record->id]) }}" class="btn btn-primary btn-sm">
