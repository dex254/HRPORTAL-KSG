        ...
        <div class="page-content">
            ...
            <div class="ms-auto">
                <div class="d-flex justify-content-start mt-4">
                    <a href="{{ route('EXT.Academic.Home') }}" class="btn previous-button px-4 py-2 me-3">Previous</a>

<button onclick="location.href='{{ route('EXT.Experince.New') }}'" class="btn next-button px-4 py-2">
    Next
</button>
                            ...
                            <table id="example" class="table mb-0 mt-3" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <form action="{{ route('EXT.Profecionalbody.destroyext', $data->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this entry?');">
                                            @csrf
                                            @method('DELETE')
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content bg-white text-dark">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('EXT.Profecionalbody.saveext') }}" method="POST" enctype="multipart/form-data">
