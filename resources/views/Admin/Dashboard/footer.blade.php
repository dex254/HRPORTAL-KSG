...
$(document).ready(function() {
    var table = $('#adminsTable').DataTable({
        ...
        autoWidth: false,
        pageLength: 10,
        dom: '<"d-flex justify-content-between mb-2"<"length-info"l><"search-box"f><"buttons-container"B>>rtip',
        // Explanation:
        // l = length changing input (counter)
    ...
    // Optional: move buttons to a specific container
    table.buttons().container().appendTo('#adminsTable_wrapper .buttons-container');
});
</script>
<script>
$(document).ready(function() {
    ...
    // Optional: move buttons to a specific container
    table.buttons().container().appendTo('#innovationTable_wrapper .buttons-container');
});
</script>
<script>
$(document).ready(function() {
    var table = $('#innovationsuser').DataTable({
        responsive: true,
        lengthChange: true,
        autoWidth: false,
        pageLength: 10,
    ...
    // Optional: move buttons to a specific container
    table.buttons().container().appendTo('#innovationsuser_wrapper .buttons-container');
});
</script>

   <script>
$(document).ready(function() {
    var table = $('#innovationsdetails').DataTable({
        responsive: true,
        lengthChange: true,
        autoWidth: false,
        pageLength: 10,
    ...
    // Optional: move buttons to a specific container
    table.buttons().container().appendTo('#innovationsdetails_wrapper .buttons-container');
});
</script>

 <script>
$(document).ready(function() {
    var table = $('#ctdrtTable').DataTable({
        responsive: true,
        lengthChange: true,
        autoWidth: false,
        pageLength: 10,
    ...
    // Optional: move buttons to a specific container
    table.buttons().container().appendTo('#ctdrtTable_wrapper .buttons-container');
});
</script>
