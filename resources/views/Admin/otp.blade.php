    ...
    <div class="row g-0 justify-content-center w-100 m-xxl-5 px-xxl-4 m-3">
        <div class="col-xl-4 col-lg-5 col-md-6">
            <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                ...
                <p class="text-muted mb-4">Enter the 6-digit code sent to your admin email.</p>

                <!-- ✅ Admin OTP Verification Form -->
<form method="POST" action="{{ route('Admin.otp.verify') }}" class="text-start mb-3" id="otpForm">
    @csrf
    ...
    <div class="text-center mt-3">
        <a href="{{ route('admin.resend.otp', ['email' => $email]) }}" class="text-muted border-bottom border-dashed">Resend OTP</a>
    </div>
</form>
