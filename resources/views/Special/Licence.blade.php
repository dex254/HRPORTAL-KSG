    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Practising  License</div>
                <div class="ps-3">
                ...
                <div class="alert alert-info mt-3" role="alert">
                    ...
                    State Practising  License .
                   
                </div>
            </div> <!--end breadcrumb-->
            <div class="ms-auto">
                <div class="d-flex justify-content-start mt-4">
                    <a href="{{ route('Special.Association') }}" class="btn previous-button px-4 py-2 me-3">Previous</a>

                    <button onclick="location.href='{{ route('Special.Medical') }}'" class="btn next-button px-4 py-2">
                        Next
                    </button>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content bg-white text-dark">
            <div class="modal-header">
                <h5 class="modal-title">Practising Licences</h5>
            ...
            <div class="modal-body">
                <form id="licenseForm" action="{{ route('Licence.licencepost') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Do you have any practising license?</label>
                        <div>
