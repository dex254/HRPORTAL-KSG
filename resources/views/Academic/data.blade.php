...
@media (max-width: 768px) {
                            ...
                            <tbody>
                                @forelse($trainning as $index => $course)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('academic.destroy', $course->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></button>
                                            </form>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
                ...
                <tbody>
                    @forelse($professionals as $index => $pro)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('academic.destroy', $pro->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                    @csrf
                                    @method('DELETE')
            ...
            <!-- Modals -->
            @include('HR.Dashboard.Modals.AcademicModal')
            @include('HR.Dashboard.Modals.TrainingModal')
            @include('HR.Dashboard.Modals.ProfessionalModal')
