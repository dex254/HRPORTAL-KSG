        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="alert alert-info mt-3" role="alert">
                    ...
                    Please provide your academic qualifications and short courses starting with the most recent.<br>
    <strong>Note:</strong> A Training of Trainers (TOT) Certificate (will be an added advantage) under the short courses.
                </div>
                
            </div> <!--end breadcrumb-->
            <div class="ms-auto">
                <div class="d-flex justify-content-start mt-4">
                    <a href="{{ route('HRPU.Dashboard') }}" class="btn previous-button px-4 py-2 me-3">Previous</a>
                
                    <button onclick="location.href='{{ route('Special.ProfessionalBodyext') }}'" class="btn next-button px-4 py-2">
                        Next
                    </button>
                </div>
        ...
        flickerEffect('error-message');
                    ...
                    <th>Action</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- Delete Button -->
                                        <form action="{{ route('academic.destroyext', $academic->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                            @csrf
                                            @method('DELETE')
               ...
               <div id="academicModal" class="modal">
                <div class="modal-content">
                    ...
                    <form action="{{ route('Academic.Ext') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Hidden Fields -->
    ...
    transition: width 0.3s ease;
            ...
            <div id="trainingModal" class="modal">
                <div class="modal-content">
                    ...
                    <form action="{{ route('Academic.Trainingext') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Hidden Fields -->
                        <input type="hidden" name="upn_no" value="{{ Auth::guard('HRPU')->user()->upn_no }}">
                        <input type="hidden" name="email" value="{{ Auth::guard('HRPU')->user()->email }}">
