                                        ...
                                        <form class="row g-3" action="{{ route('password.staff.update',$staff->email) }}" method="POST">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" class="form-control" name="email" id="email" value="{{ $staff->email }}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" name="iden" id="idnumber" value="{{ $staff->idnumber }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="department" id="department" value="{{ $staff->department }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
												<label for="inputCampus" class="form-label">User Type</label>
													...
													<select name="usertype" class="form-select form-select-lg mb-3">
														<option value="Dual user" {{ $staff->usertype == 'Dual user' ? 'selected' : '' }}>Dual user</option>
        <option value="Coordinator" {{ $staff->usertype == 'Coordinator' ? 'selected' : '' }}>Coordinator</option>
        <option value="Facilitator" {{ $staff->usertype == 'Facilitator' ? 'selected' : '' }}>Facilitator</option>
                                                ...
                                                <div id="campus">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="campus" id="LowerKabete" value="Lower Kabete" 
                                                            {{ $staff->campus == 'Lower Kabete' ? 'checked' : '' }} required>
