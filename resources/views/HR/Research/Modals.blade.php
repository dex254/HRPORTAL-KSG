...
<div id="academicModal" class="modal">
    <div class="modal-content">
       ...
       <form action="{{ route('Other.post.Researchsave') }}" method="POST" enctype="multipart/form-data">
    @csrf
...
<div id="trainingModal" class="modal">
    <div class="modal-content">
        <h3 class="modal-title">Add Research Assignment</h3>
         <form action="{{ route('Other.Research') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Hidden Fields -->
                         <input type="hidden" name="upn_no" value="{{ Auth::guard('HR')->user()->upn_no }}">
    <input type="hidden" name="email" value="{{ Auth::guard('HR')->user()->email }}">
...
<div id="publicationModal" class="modal">
    <div class="modal-content">
        ...
        <form action="{{ route('Researchext.Publication') }}" method="POST" enctype="multipart/form-data">
            @csrf
