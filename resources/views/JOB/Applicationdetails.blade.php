    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <p><strong>Job Title:</strong> {{ $job->Designation }}</p>
                            <p><strong>Reference No:</strong> {{ $job->Ref_No }}</p>
                            <p><strong>Department:</strong> {{ $job->Department ?? 'N/A' }}</p>
                            <p><strong>Description:</strong> {{ $job->Description }}</p>
                            <p><strong>Positions:</strong> {{ $job->Proposed_No_of_Positions }}</p>
            ...
            <div class="mt-4 d-flex justify-content-between">
                ...
                <form action="{{ route('JOB.abort', ['id' => $application->id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this application?');">
                    @csrf
                    @method('DELETE')
