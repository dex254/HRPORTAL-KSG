                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Create  a  job advart</li>
                        </ol>
                    </nav>
                </div>
                @if (session('success'))
...
if (document.getElementById('error-message')) {
  flickerEffect('error-message');
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <form class="row g-3" action="{{ route('JOB.createdataext') }}" method="POST"  >
                                        @csrf
    
                                        <div class="row g-3">

    <div class="col-md-6">
        <label for="area" class="form-label">Functional Area</label>
    ...
    <div class="col-md-6">
        <label for="Specialization" class="form-label">Proposed  No  of Positions</label>
        <input type="number" class="form-control" name="Proposed_No_of_Positions" required />
    </div>
