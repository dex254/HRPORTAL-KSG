        ...
        <div class="page-content">
            ...
            <div class="ms-auto">
                <div class="d-flex justify-content-start mt-4">
                    ...
                    <button onclick="location.href='{{ route('Experience.Teaching') }}'" class="btn next-button px-4 py-2">
                        Next
                    </button>
    ...
    if (document.getElementById('error-message')) {
        flickerEffect('error-message');
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Delete Button -->
                            <form action="{{ route('Experience.destroyext', $experience->id) }}" method="POST">
    @csrf
    @method('DELETE')
    <button type="submit" class="btn btn-danger btn-sm">Delete</button>
                ...
                <div id="academicModal" class="modal">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('Experience.Ext') }}"   method="POST"  >
                            @csrf
