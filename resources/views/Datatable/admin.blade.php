                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">All admin Members</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto">
                            <a href="/admin/add_admin" class="btn btn-light radius-30 mt-2 mt-lg-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($admin->role === 'Admin')
                                            ...
                                            @elseif ($admin->role === 'dex')
                                            <span class="badge bg-dark">Developer</span>
                                        @elseif ($admin->role === 'AdminAssistant')
                                            <span class="badge bg-warning">Admin Assistant</span>
                                        @elseif ($admin->role === 'Manager')
                                            <span class="badge bg-primary">Manager</span>
                                     @elseif ($admin->role === 'Support')
                                            <span class="badge bg-primary">Sapport</span>
                                        @endif
                                    </td>
                                   
                                    <td>
                                        @if ($admin->is_online === 0)
                                        <span class="badge bg-danger">Offline</span>
                                    @elseif ($admin->is_online === 1)
                                        <span class="badge bg-success">Online</span>
                                    @endif
                                    
                                    </td>
                                    <td>{{ $admin->login_time }}</td>
                                    <td>{{ $admin->logout_time }}</td>
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="{{ route('Admin.accounts', ['id' => $admin->id]) }}" class="ms-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Update"><i class="bx bxs-edit"></i></a>
