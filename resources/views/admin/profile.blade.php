                ...
                <div class="ms-auto">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
                            <a class="dropdown-item" href="/admin/profile/edit">Edit Profile</a>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <div class="user-img rounded-circle" style="width: 200px; height: 200px; background-color: #05EA27FF; display: flex; align-items: center; justify-content: center; overflow: hidden;">
                                            ...
                                            @if ($admin->image)
                                                <img src="{{ asset('profile/' . $admin->image) }}" class="user-img" alt="user avatar" style="width: 100%; height: 100%; object-fit: cover;">
                                                @else
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Online  Status</h6>
                                        </div>
                                        <div class="user-status" style="width: 100px; height: 40px; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 16px; background-color: {{ Auth::guard('admin')->user()->is_online ? '#28a745' : '#dc3545' }}; border-radius: 5px;">
                                            <p style="margin: 0;">
                                                {{ Auth::guard('admin')->user()->is_online ? 'Online' : 'Offline' }}
                                            </p>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" value="{{ Auth::guard('admin')->user()->login_time}}" readonly />
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" value="{{ Auth::guard('admin')->user()->idnumber}}" readonly />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" value="{{ Auth::guard('admin')->user()->campus}}"; " readonly />
                                        </div>
                                    </div>
