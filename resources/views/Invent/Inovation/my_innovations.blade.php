        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive-sm">
                    <table id="innovationsTable" class="table table-striped mb-0">
                        <thead>
                            <tr>
                                <th>#</th>
...
<td>
    ...
    @endif
                                    ...
                                    <!-- Update Button -->
                                    <td>
                                        <a href="{{ route('innovation.edit', $innovation->id) }}" 
                            ...
                            @empty
                                <tr>
                                    <td colspan="11" class="text-center text-muted">No innovations submitted yet.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
