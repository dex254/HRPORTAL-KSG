        ...
        <header>
			<div class="topbar d-flex align-items-center">
				<nav class="navbar navbar-expand gap-3">
                    <button class="dashboard-button" onclick="markCompleteAndNavigate('{{ route('HRPU.Myapplicants') }}')">
                        My Applications
                    </button>
            
                    <!-- My Profile Button -->
                    <button class="dashboard-button" onclick="markCompleteAndNavigate('{{ route('HRPU.Dashboard') }}')">
                        My Profile
                    </button><style>
                        /* Dashboard Buttons */
                        .dashboard-button {
...
.dashboard-button:hover {
    ...
    border: 1px solid rgb(114, 140, 125) !important; /* Brown border on hover */
                    ...
                    <span class="nav-link fw-bold" style="color: brown; font-size: 2.0rem;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;KSG Adjunct Faculty Portal</span>
                    ...
                    <div class="user-box dropdown px-3">
                        <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="form-elements.html#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="user-info">
                                <p class="user-name mb-0"> {{ Auth::guard('HRPU')->user()->name}}, </p>
                                <p class="designattion mb-0">{{ Auth::guard('HRPU')->user()->designation}}: {{ Auth::guard('HRPU')->user()->campus}} </p>
                            </div>
                        </a>
						
                        <ul class="dropdown-menu dropdown-menu-end" style="background-color: white; color: black;">
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="/The_application_dashboard" style="color: black;">
                                    <i class='bx bx-home-alt'></i>
                                    <span>Home</span>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="/Complete_update" style="color: black;">
