...
if ($request->hasFile('recommendation_document')) {
  ...
  return redirect()->back()->with('error', 'Failed to upload document.');
    ...
    public function teaching()
    {
        ...
        return view('Experience.Teaching.EXT', compact('teachings'));
    }

    // Store experience data
    public function teachingpost(Request $request)
    {
        // Validate input
        $request->validate([
             'name' => 'required|string',
...
if ($request->hasFile('recommendation_document')) {
  ...
  return redirect()->back()->with('error', 'Failed to upload document.');
    ...
    public function teachingdestroyext($id)
    {
        $teachings = Teaching::findOrFail($id);
    ...
    //EXTERNAL PRPCESS  OF  TECHIG  EXPERENCE
     public function teachinghr()
    {
        ...
        return view('Experience.Teaching.HR', compact('teachings'));
    }

    // Store experience data
    public function teachingposthr(Request $request)
    {
        // Validate input
        $request->validate([
             'name' => 'required|string',
...
if ($request->hasFile('recommendation_document')) {
  ...
  return redirect()->back()->with('error', 'Failed to upload document.');
    ...
    public function teachingdestroyextHR($id)
    {
        $teachings = Teaching::findOrFail($id);
