...
class ResearchPublication extends Controller
{
    //
    public function ResearchHomeext()
    {
...
$others = Other::where('upn_no', $userUpnNo)
    ...
    ->get();
        ...
        return view('Research.EXT.Home', compact('other','others', 'publications'));
    }
    public function Researchotherpostext(Request $request)
    {
    ...
    'document_name' => $documentName,
     ...
     public function Researchotherspostext(Request $request)
    {
...
public function ResearchotherspostPublication(Request $request)
{
    // Validate the input data
    $request->validate([
        'name' => 'required|string',
    ...
    public function Researchdestroyotherext($id)
    {
